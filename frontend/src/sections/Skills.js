  ...
  return (
    <section id="skills">
      ...
      <div className="skills-container">
        <div className="divSkills">
          ...
          <div className="divSkills_container">
            ...
            <div className="divSkills_container_box">
              ...
              <div className="icon-wrapper">
                <i className="devicon-mongoose-original"></i> <p>Mongoose</p>
              </div>
              <div className="icon-wrapper">
        ...
        <div className="divCV">
          <h1>CV</h1>
          <div className="divCV__container">
            <Image
              src="https://res.cloudinary.com/dzdpmnb00/image/upload/v1730222524/CV_Bouhafs-Celine_light_kqv5ot.jpg"
              alt="CV"
              className="divCV__CV"
              fill
              priority
          ...
          <a
            href="https://drive.google.com/uc?id=1BUa3Z0zBkWfD-6kMpndYRuXTTXgeNpgY&export=download"
            className="divCV__link"
